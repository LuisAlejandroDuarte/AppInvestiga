...
.directive('numeroValido', function () {
  ...
  .config(['$routeProvider','$compileProvider',function ($routeProvider,$compileProvider) {
    ...
    .when('/zona', {
       ...
       .when('/menuInvestigador', {

        templateUrl: 'views/menuInvestigador.html',

       controller: 'MenuInvestigador'



      })

      .when('/menuConvocatoria', {

        templateUrl: 'views/menuConvocatorias.html',

       controller: 'MenuConvocatorias'
      ...
      .when('/menuGrupo', {
        ...
        templateUrl: 'views/menuGrupo.html',

       controller: 'MenuGrupo'
